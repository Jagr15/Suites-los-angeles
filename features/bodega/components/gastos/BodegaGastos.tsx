                            ...
                            >
                                <TableCell className="px-6">
                                    <div className="flex flex-col">
                                        <span
                                            className={
                                                item.isTotal
                                                    ? "font-bold text-primary-700 text-sm uppercase"
                                ...
                                <TableCell className="px-6">
                                    {!item.isTotal ? (
                                        ...
                                        <span className="text-primary font-bold opacity-30">—</span>
                                    )}
                                </TableCell>
                                <TableCell
                                    className={
                                        item.isTotal
                                            ? "text-primary font-bold opacity-30"
                                ...
                                <TableCell className="text-right">
                                    ...
                                    >
                                        <span
                                            className={
                                                item.isTotal ? "text-primary/60 mr-1 text-sm" : "text-default-400 mr-1 text-xs"
                                            }
                                        >
                                            $
                                        </span>
